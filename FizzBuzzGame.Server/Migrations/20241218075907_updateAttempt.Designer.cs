...
namespace FizzBuzzGame.Server.Migrations
{
    ...
    [Migration("20241218075907_updateAttempt")]
            ...
            modelBuilder.Entity("FizzBuzzGame.Server.Models.Attempt", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CorrectNumber = 3,
                            CreatedAt = new DateTime(2024, 12, 18, 7, 59, 6, 832, DateTimeKind.Utc).AddTicks(2902),
                            Duration = 60,
                            GameId = 1,
                            IncorrectNumber = 1,
                            IsCompleted = true,
                        ...
                        new
                        {
                            Id = 2,
                            CorrectNumber = 2,
                            CreatedAt = new DateTime(2024, 12, 18, 7, 59, 6, 832, DateTimeKind.Utc).AddTicks(2908),
                            Duration = 45,
                            GameId = 2,
                            IncorrectNumber = 2,
                            IsCompleted = true,

...
namespace FizzBuzzGame.Server.Migrations
{
    ...
    [Migration("20241223131641_removeDescriptionFromRule")]
    partial class removeDescriptionFromRule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FizzBuzzGame.Server.Models.Attempt", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CorrectNumber = 3,
                            CreatedAt = new DateTime(2024, 12, 23, 13, 16, 40, 955, DateTimeKind.Utc).AddTicks(8727),
                            Duration = 60,
                            GameId = 1,
                            IncorrectNumber = 1,
                            IsCompleted = true,
                        ...
                        new
                        {
                            Id = 2,
                            CorrectNumber = 2,
                            CreatedAt = new DateTime(2024, 12, 23, 13, 16, 40, 955, DateTimeKind.Utc).AddTicks(8736),
                            Duration = 45,
                            GameId = 2,
                            IncorrectNumber = 2,
                            IsCompleted = true,
